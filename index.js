...
// git remote -v - проверяет привязку между локальным репозиторием и репозиторием на Github.
// git remote add origin URL с Github - осуществляет привязку между локальным репозиторием и репозиторием на Github.
